  ...
  $(document).ready(function() {
	$.post('/index.php/index/updateToken', {channel: channel});
    ...
    // to configure it
    var RealtimeAppKey = "qqcB8u";

    console.log('curl "http://ortc-developers-useast1-s0001.realtime.co/send" --data "AK=' + RealtimeAppKey + '&AT=SomeToken&C=' + channel + '&M=12345678_1-1_This is a web push notification sent using the Realtime REST API"');
